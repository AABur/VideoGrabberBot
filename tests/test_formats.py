...
class TestFormats:
    ...
    def test_get_available_formats(self, mock_video_formats, mock_audio_formats, clear_format_cache):
    ...
    def test_get_format_options(self, mock_video_formats, mock_audio_formats, clear_format_cache):
    ...
    def test_get_format_by_id(self, mock_video_formats, mock_audio_formats, clear_format_cache):
    ...
    def test_get_format_by_id_edge_cases(self, mock_video_formats, mock_audio_formats, clear_format_cache):
        """Test edge cases for get_format_by_id."""
        # Test with empty string
        format_data = get_format_by_id("")
        assert format_data is None

        # Test with None (would raise TypeError in typed code, but testing for robustness)
        with pytest.raises(Exception):
            get_format_by_id(None)  # type: ignore
